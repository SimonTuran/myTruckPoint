...
import { AiChatPanel } from "@/components/chatbot"
    ...
    return (
        <div className="flex min-h-dvh flex-col bg-background">
            ...
            <div className="flex flex-1">
                ...
                <aside
                    className={cn(
                        "sticky top-14 hidden h-[calc(100dvh-3.5rem)] shrink-0 border-r border-border bg-card transition-[width] duration-200 lg:block",
